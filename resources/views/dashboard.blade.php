<x-css-layout>
    <!-- start: Sidebar -->
    <div class="fixed left-0 top-0 w-64 h-full bg-gray-900 p-4 z-50 sidebar-menu transition-transform scroll-smooth">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <img src="{{asset('storage/component/favicon.png')}}" alt="" class="h-8">
            <span class="text-lg font-bold text-white ml-3">Skyline</span>
        </a>
        <ul class="mt-4">
